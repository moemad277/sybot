...
AS $$
DECLARE
  project_url TEXT := 'https://twpxuknajnjrjjehbobx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR3cHh1a25ham5qcmpqZWhib2J4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDYyNDIzNywiZXhwIjoyMDUwMjAwMjM3fQ.tks0krloSVxM_CCPP16s-LZtsciEE-hK1CAkB1HglgI'; -- full access needed for http request to storage
